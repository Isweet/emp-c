...
bit_t *bit_not(semihonest_t *sh, netio_t *io, bit_t *v);
...
bit_t *bit_cond(semihonest_t *sh, netio_t *io, bit_t *guard, bit_t *lhsc, bit_t *rhsc);
bool bit_reveal(semihonest_t *sh, netio_t *io, bit_t *vc, int party);
void bit_destroy(bit_t *v);

struct integer;
typedef struct integer integer_t;
integer_t *integer_create(semihonest_t *sh, netio_t *io, int length, int64_t v, int party);
...
integer_t *integer_cond(semihonest_t *sh, netio_t *io, bit_t *guard, integer_t *lhsc, integer_t *rhsc);
